...
map_data.npc_squads = {
    ...
    { "civilian", Vector(-2292.03125,-1458.5891113281,128.03125), Angle( 0 ,2.5064969062805, 0 ) },
    // -------------------------------------------
    //            UPPER AREA
    // -------------------------------------------
    { "combine", Vector(-775.34155273438,918.08001708984,64.03125), Angle( 0 ,147.16799926758, 0 ) },
    // -------------------------------------------
    //            ROAD NEAR KLEIN SPAWN
    // -------------------------------------------
    { "metrocop", Vector(-2771.3073730469,-2636.1540527344,-195.96875), Angle( 0 ,25.562702178955, 0 ) },
    { "rebel", Vector(-3382.564453125,-1805.4049072266,-319.96875), Angle( 0 ,21.317962646484, 0 ) },
    { "civilian", Vector(-3278.6916503906,-2257.7131347656,-191.96875), Angle( 0 ,124.22741699219, 0 ) }
}
...
map_data.npcs = {
    ...
    // skybridge
    {
        "npc_combine_s",
        "weapon_ar2",
        Vector(849.24658203125,2354.8110351563,96.03125),
        Angle( 0 ,-0.64226090908051, 0 )
    },
    {
        "npc_combine_s",
        "weapon_ar2",
        Vector(816.52874755859,1587.4392089844,96.03125),
        Angle( 0 ,179.94789123535, 0 )
    },     
    // end of platform
    {
        "npc_metropolice",
    ...
    },
    {
        "npc_metropolice",
        "weapon_pistol",
        Vector(801.11981201172,1198.3919677734,-287.96875),
        Angle( 0 ,15.164491653442, 0 )
    },
    // security checpoint A
    {
        "PrisonShotgunner",
        "weapon_shotgun",
        Vector(2799.5681152344,1061.7302246094,-191.96875),
        Angle( 0 ,-166.69039916992, 0 )
    },     
    // queue / security checkpoint B
    {
        "npc_metropolice",
        "weapon_smg1",
    ...
    // -------------------------------------------
    {
        "Rebel",
        "weapon_smg1",
        Vector(-3486.80078125,3057.8046875,-319.96875),
        Angle( 0 ,-25.916307449341, 0 )
    },
    {
        "Rebel",
        "weapon_pistol",
        Vector(-3221.8342285156,3110.9350585938,-319.96875),
        Angle( 0 ,-120.73622131348, 0 )
    },     
    // -------------------------------------------
    //            APARTMENT PLAZA
    // -------------------------------------------
    ...
    },
    {
        "npc_metropolice",
        "weapon_pistol",
        Vector(2636.3332519531,-888.68469238281,0.03125),
        Angle( 0 ,-90.608299255371, 0 )
    },
    // -------------------------------------------
    //            APARTMENT ROOFS
    // -------------------------------------------
    ...
    },
    {
        "Medic",
        "weapon_pistol",
        Vector(-2904.4143066406,-1487.8721923828,272.03125),
        Angle( 0 ,-91.067184448242, 0 )
    },
    {
        "Rebel",
        "weapon_smg1",
        Vector(-2263.6271972656,-1506.7739257813,298.82943725586),
        Angle( 0 ,-89.967254638672, 0 )
    },
    {
        "Rebel",
        "weapon_ar2",
        Vector(-252.26036071777,-1238.9344482422,420.19268798828),
        Angle( 0 ,-89.722076416016, 0 )
    },
    {
        "Rebel",
        "weapon_shotgun",
        Vector(-2424.0549316406,-1212.7741699219,128.03125),
        Angle( 0 ,176.83432006836, 0 )
    },
    // -------------------------------------------
    //            UPPER AREA
    // -------------------------------------------
    {
        "CombineElite",
        "weapon_ar2",
        Vector(-1413.0640869141,1158.1271972656,64.03125),
        Angle( 0 ,158.55281066895, 0 )
    }
}
...
map_data.item_spawns = {
    ...
    Vector(2737.2563476563,910.97808837891,-160.88725280762),
    // buster courtyard
    ...
    Vector(1748.1352539063,-761.12615966797,0.03125),
    Vector(3592.5134277344,-829.80084228516,-255.96875),
    Vector(2115.7048339844,-553.13934326172,20.592147827148),
    Vector(2781.5063476563,-1100.6004638672,37.561569213867),
    Vector(3597.2995605469,-850.32220458984,-255.96875),
    // rooftop secret
    ...
    Vector(-1209.9587402344,-1441.3223876953,264.0322265625),
    Vector(-1209.9587402344,-1441.3223876953,264.0322265625),
    // upper area
    Vector(-1521.9553222656,274.93518066406,102.24503326416),
    Vector(-544.03125,965.18981933594,64.035606384277),
    // kleiner spawn
    Vector(-1700.0113525391,-2189.9436035156,-319.96875),
    Vector(-3645.5131835938,-1508.8959960938,-282.3203125)
}